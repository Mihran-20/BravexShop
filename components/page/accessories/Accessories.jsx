    ...
    return (
        <section className="min-h-screen bg-gradient-to-r from-[#1a1a1a] via-[#131313] to-[#FFC26F] px-4 pb-12 pt-24">
            <header className="relative mb-12 select-none text-center">
                <h1
                    className="
                        text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-wider
                        text-[#FFC26F] drop-shadow-[0_0_4px_#FFC26F]
                        sm:drop-shadow-[0_0_6px_#FFC26F]
                        md:drop-shadow-[0_0_8px_#FFC26F]
                        relative
                    "
                >
                    Accessories
